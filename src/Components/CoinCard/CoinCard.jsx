                ...
                <div className="col-11 m-auto white-coin-content">
                    <div className="row justify-content-around">
                        <div className="col-5 w-coin-left">
                            ...
                            <p>SMC is a digital currency like Bitcoin. It is designed to be a companion coin to our Wallet & NFT products. We are planning to provide incentives for using SMC coin when transacting within the SMC network. </p>
